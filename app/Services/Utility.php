...
class Utility
{
    public static function TryCatchExceptionAndReturnBackWithError(
        string $error_title,
        callable $execute_on_try,
        ?callable $execute_on_catch,
        mixed...$params
    ) {
        try {
            return $execute_on_try(...$params);
        } catch (\Exception$e) {
            if (!is_null($execute_on_catch)) {
                $execute_on_catch();
            }
    ...
    public static function GetAdminPermissions()
    {
        return [
            ...
            // Permissions for managing roles & permissions
            'view_roles' => 'view roles',
            'edit_roles' => 'edit roles',
            'add_roles' => 'add roles',
            'delete_roles' => 'delete roles',
            // Permissions for managing artisans
            'view_artisans' => 'view artisans',
            'edit_artisans' => 'edit artisans',
            'activate_artisans' => 'activate artisans',
            'deactivate_artisans' => 'deactivate artisans',
            'shortlist_artisans' => 'shortlist artisans',
            'vet_artisans' => 'vet artisans',
            'engage_artisans' => 'engage artisans',
            'demote_artisans' => 'demote artisans',
            // Permissions for managing activity logs
            'monitor_admin' => 'monitor admin',
            'monitor_artisan' => 'monitor artisan',
        ];
    }

    public static function GetRegionDistrictData()
    {
        return [
